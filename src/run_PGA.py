...
run_folder = main_path + "PGA/"
suffix = "100k"
# suffix = "augmented"
critic_path = model_path + 'critic_PGA_' + suffix + '.keras'
gen_path = model_path + 'generator_PGA_' + suffix + '.keras'
train_distribution = None

gan = ParetoGA(main_path, input_dim, critic_layers_units, critic_lr, critic_dropout, gp_weight, z_dim, generator_layers_units, generator_batch_norm_momentum, generator_lr, generator_dropout, batch_size, critic_optimizer, generator_optimizer, n_stag_iters, predictors, train_df, suffix)
